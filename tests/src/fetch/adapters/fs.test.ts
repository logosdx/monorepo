...
describe('@logosdx/fetch: file system cache adapter', async () => {
    ...
    it('should work with file system cache adapter', async () => {
        ...
        api.on('cache-set', (data) => cacheKeys.push(data.key));
    ...
    it('should handle SWR', async () => {
        ...
        api.on('cache-stale', (data) => staleEvents.push(data.path!));
        api.on('cache-revalidate', (data) => revalidateEvents.push(data.path!));
